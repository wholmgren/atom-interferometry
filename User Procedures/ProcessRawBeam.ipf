...
Function LoadAndDisplayScan2(path, fileName, displayYesNo)
	...
	LoadWave/Q/G/D/W/N/O path + filename
...
Function RezeroScan2(positionWave, countsWave)
	...
	Make/O/T/N=1 RezeroConstraints = {"K0<20", "K1<1000", "K1>1", "K3>130", "K3<200"}
	
	Variable v_FitError=0
	Variable V_FitOptions=4 
	
	CurveFit/Q/NTHR=0 gauss  countsWave  /X=positionWave /C=RezeroConstraints
	print GetRTError(1)
		
	if(v_fiterror!=0)
		Variable/G K0 = 1,K1 = 500,K2 = 1700,K3 = 100;	//provide initial guesses so that the fit is less susceptible to noise spikes
